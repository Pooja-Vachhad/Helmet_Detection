...
- Domain shift (clean to blur) - addressed via targeted blur/motion augmentation (Albumenations: MotionBlur, GaussianBlur,
ImageCompression) , improving character accuracy on blurred plates from 56% to 68%
